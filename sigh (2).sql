...
--
-- Host: localhost:3306
-- Generation Time: Sep 19, 2024 at 01:53 AM
...
(18, 'hehe', '944d0f3ad1dc4fa234c3a0bc5cb963aa', 'user'),
...
INSERT INTO `organisasi` (`id_organisasi`, `id_akun`, `unit_eselon1`, `nama_organisasi`, `alamat`, `email_badan`, `no_telp_fax`, `nip_responden`, `nama_responden`, `nilai_kategori1`, `nilai_kategori2`, `nilai_kategori3`, `nilai_kategori4`, `nilai_kategori5`, `nilai_kategori6`, `id_penilai`, `status_kuesioner`, `can_fill_out`) VALUES
(1, 1, 'Eselon I Unit 1', 'Organisasi A', 'Jl. Sudirman No. 1', 'orgA@domain.com', '021-1234567', '1234567890', 'Responden A', 90, 85, 88, 92, 86, 89, 3, 1, 1),
(2, 2, 'Eselon I Unit 2', 'Organisasi B', 'Jl. Thamrin No. 2', 'orgB@domain.com', '021-7654321', '0987654321', 'Responden B', 87, 82, 91, 84, 88, 90, 3, 1, 1),
(3, 11, 'Bapak Indonesia', '', '', '', '', '', 'Orangan sawah', 0, 0, 0, 0, 0, 0, NULL, 1, 1),
(4, 12, 'ESELON 2', 'BALAI DESA', 'JLWARNA WARNI', 'kocak@gmail.com', '08978544104', '2104712009', 'Swahan', 0, 0, 0, 0, 0, 0, 1, 1, 1),
(5, 13, 'Unit Eselon 2 ', 'Balaik Desa', 'jl warna wwanis', 'alexzarodaeli8@gmail.com', '08978544104', '0987654322', 'Alekciak', 0, 0, 0, 0, 0, 0, 7, 1, 0),
(6, 14, 'Unit Eselon 3', 'Perpustakaan Indonesia', 'jl jokowi 56 ', 'randymomsky@gmail.com', '088877775555', '1234567892', 'Momsky ah ', 0, 0, 0, 0, 0, 0, 7, 1, 1),
(7, 17, 'UNIT GAWAT DARURAT', 'UNIT KOCAK DARURAT', 'JL HEH', 'als@gmail.com', '089727121899', '2107412002', 'keke', 0, 0, 0, 0, 0, 0, 1, 1, 1),
(8, 18, 'UNIT GAWAT DARURAT', 'BONCOR', 'JL KENAN KIRI', 'AS@GMAIL.COM', '089721218181', '2107412006', 'KIWI', 0, 0, 0, 0, 0, 0, 1, 1, 1),
(9, 21, '', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, NULL, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `penilai_user_access`
--
...
--
-- Dumping data for table `penilai_user_access`
--
...
(1, 'Mengumumkan informasi deskripsi tugas dan fungsi dalam website unit organisasi eselon 1 dan atau UPT bersangkutan yang terbaru', 1, 1, 1, 1, 10, 'hehe'),
...
--
-- Table structure for table `profile_penilai`
--
...
--
-- Dumping data for table `profile_penilai`
--
...
--
-- Table structure for table `subkategori1`
--
...
--
-- Dumping data for table `subkategori1`
--
...
(3, 'INFORMASI TERKAIT DAFTAR INFORMASI PUBLIK SESUAI FUNGSI UTAMA UNIT ORGANISASI ESELON 1 DAN UPT', 3);

-- --------------------------------------------------------

--
-- Table structure for table `subkategori3`
--
...
--
-- Dumping data for table `subkategori3`
--
...
--
-- Table structure for table `user_access_status`
--
...
--
-- Indexes for table `penilai_user_access`
--
...
--
-- Indexes for table `profile_penilai`
--
...
--
-- Indexes for table `subkategori1`
--
...
--
-- Indexes for table `subkategori2`
--
...
--
-- Indexes for table `subkategori3`
--
...
--
-- Indexes for table `user_access_status`
--
...
--
-- AUTO_INCREMENT for table `penilai_user_access`
--
ALTER TABLE `penilai_user_access`
...
--
-- AUTO_INCREMENT for table `profile_penilai`
--
ALTER TABLE `profile_penilai`
  MODIFY `id_penilai` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `subkategori1`
--
ALTER TABLE `subkategori1`
  MODIFY `id_subkategori1` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `subkategori2`
--
ALTER TABLE `subkategori2`
  MODIFY `id_subkategori2` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `subkategori3`
--
ALTER TABLE `subkategori3`
  MODIFY `id_subkategori3` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `user_access_status`
--
ALTER TABLE `user_access_status`
...
--
-- Constraints for table `penilai_user_access`
--
ALTER TABLE `penilai_user_access`
...
--
-- Constraints for table `profile_penilai`
--
ALTER TABLE `profile_penilai`
